...
angular.module('fg').run(['$templateCache', function($templateCache){
  $templateCache.put('angular-form-gen/edit/edit.ng.html', '<div class=\"fg-edit row form-group\" ng-form=\"$fg\"><div class=\"col-sm-16\"><div fg-form=\"\" fg-edit-canvas=\"\" fg-no-render=\"true\"></div></div><div class=\"col-sm-8\" ng-form=\"$palette\" fg-null-form=\"\"><div fg-form=\"\" fg-edit-palette=\"\" fg-no-render=\"true\"></div></div></div>');
  ...
  $templateCache.put('angular-form-gen/form/field/field.ng.html', '<div class=\"fg-field-inner form-group\" ng-class=\"{ \'fg-field-required\': fieldSchema.validation.required}\"><label ng-if=\"!field.schema.nolabel\" class=\"col-sm-22 control-label col-sm-offset-1\" for=\"{{ field.$_id }}\" style=\"margin-bottom: 6px\">{{ fieldSchema.displayName }}</label><div class=\"col-sm-24 included-field-template\"><div ng-include=\"renderInfo.templateUrl\"></div><div fg-validation-summary=\"\" fg-validation-messages=\"fieldSchema.validation.messages\" ng-if=\"!noValidationSummary\"></div></div></div>');
...
fg.directive('fgEdit', ["$rootScope", function ($rootScope) {
  return {
    priority: 100,
    require: 'fgSchema',
    restrict: 'AE',
...
fg.directive('fgDateInput', ["fgDateInputLinkFn", function(fgDateInputLinkFn) {
  return {
...
}]).factory('fgPropertyFieldCommonLinkFn', ["$rootScope", function($rootScope) {
  return function($scope, $element, $attrs, ctrls) {
    $scope.previous = {};
    angular.copy($scope.field, $scope.previous);
